...
$ git clone git@github.com:nicholas-maltbie/ProjectCage.git
# If you do not have ssh key setup, you can download via https
$ git clone https://github.com/nicholas-maltbie/ProjectCage.git
```
...
`~/projects/ProjectCage`. Then hit the `Open` 
